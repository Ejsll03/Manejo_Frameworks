...
if (!componentName) {
  console.error(
    "❌ Debes indicar el nombre de la pagina. Ej: node createpage Login"
  );
  process.exit(1);
}
if (!/^[A-Z]/.test(componentName)) {
  ...
  console.error(
    "❌ El nombre de la pagina debe comenzar con mayúscula. Ej: Login"
  );
  process.exit(1);
}
...
console.log(
  `✅ Componente ${componentName} creado en ${baseDirJsx} y ${baseDirCss}`
);
